...
class InferenceDatasetReader(BaseDatasetReader):
    ...
    def __init__(self, index_reader, n_tokens, task_name, model_name, field, dataset_path=None,
                 dataset_split=None, ds_size=None, advanced_scoring=False):
        ...
        self.advanced_scoring = advanced_scoring
    ...
    def get_ice_prompt(self, entry, prompt_len):
        if self.advanced_scoring and ('best_permutations' in entry):
            ctx = [self.index_reader[i] for i in entry['best_permutations']]
