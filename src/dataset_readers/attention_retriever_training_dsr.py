...
def encode_field(example, **kwargs):
    ...
    return {
        ...
        "best_permutations": example['best_permutations'],
        "score_gained": example['score_gained'],
    }


class AttentionRetrieverTrainingDatasetReader(torch.utils.data.Dataset):
